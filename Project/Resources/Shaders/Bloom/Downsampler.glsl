...
void main()
{
     ...
     //if ((fullTexColor.r < 1.0 || fullTexColor.g < 1.0 || fullTexColor.b < 1.0)) { fragColor = vec4(0.0); return};
     //if (fullTexColor.a < 0.1) discard;
    ...
    downsample = min(downsample, 0.99f);
    downsample = max(downsample, 0.0001f);
    //downsample = vec3(1.0, 0.0, 1.0);
}