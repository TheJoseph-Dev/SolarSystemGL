...
public:
	...
	//FrameBuffer() {};
	FrameBuffer(float width, float height, bool border = false);
	~FrameBuffer();
	...
	void Draw(bool shouldTonemap = false, int preLoadedTextureID = -1);
...
public:
	...
	void Draw(const FBTexture& srcTexture, float filterRadius);
